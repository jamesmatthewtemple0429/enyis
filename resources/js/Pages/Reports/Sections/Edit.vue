...
<script>
export default {
    props: ['section','report','territories','counties','models','fields'],

    created() {
        this.selectedFields = _.map(this.section.fields, (field) => {
            console.log(field);
    ...
    data() {
        return {
            ...
            field: this.section.field,
            model: this.section.model,

            selectedFields: this.section.fieldNames,
            territory: this.section.territory,
            county: this.section.county,
    ...
    methods: {
        submit: function() {
            this.form.patch(route('reports.sections.update',{ report: this.report, section: this.section }));
        },
