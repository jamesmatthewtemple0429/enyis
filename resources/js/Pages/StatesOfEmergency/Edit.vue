...
export default {
    ...
    data() {
        return {
            form: useForm({
                type: this.soe.type,
                counties: this.soe.county_ids,
                description: this.soe.description,
                expires_at: this.soe.expires_at,
            })
        };
    },
    ...
    methods: {
        ...
        submit: function() {
            this.form.patch(route('statesofemergency.update',this.soe));
        },
...
<template>
    <AppLayout title="Edit State of Emergency">
        <template #header>
