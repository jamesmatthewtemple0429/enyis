...
export default {
    ...
    data() {
        return {
            form: useForm({
                type: this.edict.type,
                sub_type: this.edict.sub_type,
                counties: this.edict.county_ids,
                description: this.edict.description,
                expires_at: this.edict.expires_at,
            })
        };
    },
    ...
    methods: {
        ...
        submit: function() {
            this.form.patch(route('travelbans.update', this.edict));
        },
...
<template>
    <AppLayout title="Edit Travel Warning">
        <template #header>
                ...
                <div class="py-4 px-4 text-white bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                    <form @submit.prevent="submit">
                        <div class="w-1/2">
                            ...
                            <div class="mt-4 col-span-6 sm:col-span-4 mb-6">
