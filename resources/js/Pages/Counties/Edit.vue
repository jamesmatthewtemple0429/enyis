...
export default {
    ...
    data() {
        return {
            form: useForm({
                ...
                territory: this.county.territory,
                chapter: this.county.chapter
            })
        };
    },
    ...
    methods: {
        submit: function() {
            this.form.patch(route('counties.update', this.county));
        },
                    ...
                    <form @submit.prevent="submit">
                        <div class="w-1/2">
                            ...
                            <div class="col-span-6 sm:col-span-4 mb-6">
                                <InputLabel for="value" value="County Name" />
                                <TextInput
                                    id="name"
                                    v-model="form.name"
                                    type="text"
                            ...
                            <div class="col-span-6 sm:col-span-4 mb-6">
                                <InputLabel for="value" value="Territory" />
                                <TextInput
                                    id="name"
                            ...
                            <div class="col-span-6 sm:col-span-4 mb-6">
                                <InputLabel for="value" value="Chapter" />
                                <TextInput
                                    id="name"
