...
<script>
    export default {
        ...
        methods: {
            submit: function() {
                this.form.post(route('distributionlists.store'));
            },
...
<template>
    <AppLayout title="Create Distribution List">
        <template #header>
                ...
                <div class="py-4 px-4 text-white bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                    <form @submit.prevent="submit">
                        <div class="w-1/2">
                            ...
                            <div class="mb-2"><label >Include Primary DO <input @input="include_primary = ! include_primary" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 ml-2" type="checkbox"></label></div>
                            <div class="mb-2"><label >Include Backup DO <input @input="include_backup = ! include_backup" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 ml-2" type="checkbox"></label></div>
                            <div class="mb-2"><label >Include Supervisor<input @input="include_supervisor = ! include_supervisor" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 ml-2" type="checkbox"></label></div>
